...
//Allocate memory for the starting node
...
//Exit if no memory has been allocated
   ...
   else
   {
   	...
   	//Save user input to the data element of the noode
   	...
   	//Use a loop to generate the succeding nodes
...
static void displayList()
{
	...
	{
		//Check if the current node is emp
	}
}